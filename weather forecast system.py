...
def data_get():
 city = city_name.get()
 data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=736fc09227864c78f4f1c78aafe32873").json()
...
win = Tk()
win.title ("Weather")
win.config(bg = "dark red")
win.geometry("500x500")

name_label = Label(win,text="weather forecast system",
